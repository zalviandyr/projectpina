...
<head>
  ...
  <title>Article - Fathforce Starter Kits Pro</title>
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center ">
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <div class="logo">
        <h1 class="text-light"><a href="/"><span>Starter Kits Pro</span></a></h1>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry">
              ...
              <div class="entry-img">
                <img src="../../landing/assets/img/blog/blog-2.jpg" alt="" class="img-fluid">
              </div>
            ...
            <article class="entry">
              ...
              <div class="entry-img">
                <img src="../../landing/assets/img/blog/blog-3.jpg" alt="" class="img-fluid">
              </div>
            ...
            <article class="entry">
              ...
              <div class="entry-img">
                <img src="../../landing/assets/img/blog/blog-4.jpg" alt="" class="img-fluid">
              </div>
  ...
  <footer id="footer" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="500">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="#">Themes</a></li>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Article</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">License</a></li>
          ...
          <div class="col-lg-3 col-md-6 footer-info">
            <h3>About FathForce Starter Kits Pro</h3>
    ...
    <div class="container">
      <div class="copyright">
        Fathforce Starter Kits Pro Copyright@2021
      </div>
      <div class="credits">
